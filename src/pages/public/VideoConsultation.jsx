...
const VIDEO_FAQS = [
  ...
  },
  {
    ...
    answer: 'Yes. If the doctor prescribes medication, a signed digital prescription is added to your LabEasy dashboard immediately after the call. It is valid at pharmacies across Bangladesh and can be downloaded as a PDF anytime.',
  },
  {
    id: 3,
      ...
      <section className="section-padding">
        <div className="container-custom">
          <SectionHeading
            ...
            subtitle="The entire journey happens on LabEasy — booking, consultation, prescription and follow-up."
          />
          ...
          {shownTestimonials.length > 0 && (
            <>
              <SectionHeading
                ...
                subtitle="Real experiences from patients who consulted doctors on LabEasy."
              />
              <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
