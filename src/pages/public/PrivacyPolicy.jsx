        ...
        <div className="container-custom">
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mt-6 text-sm leading-relaxed text-gray-600 sm:text-base">
              Lab Easy (&ldquo;we&rdquo;, &ldquo;us&rdquo; or &ldquo;our&rdquo;) provides doctor
              appointments, video consultations, diagnostic test bookings and digital health records
              through the Lab Easy website and services. Your health information is among the most
            ...
            <Section title="5. Third parties">
              <p>We share data with a limited set of service providers, strictly to run Lab Easy:</p>
              <ul className="list-disc space-y-2 pl-5">
                <li>
